...
import { GitBranch, Cloud, Shield, Terminal, Blocks, ArrowRightLeft, Lock } from 'lucide-react';
...
const services = [
  ...
  },
  {
    ...
    description: "Protect your business with military-grade security measures",
    features: [
      "Zero-Trust Security",
