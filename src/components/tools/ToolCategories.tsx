import { 
  ...
  Table, Boxes, Layout, Workflow, ArrowRightLeft
} from 'lucide-react';
...
export const toolCategories = [
  ...
  },
  {
    ...
    icon: Workflow,
    items: ["Github Actions", "Jenkins", "Groovy", "CircleCI", "GitLab CI", "Azure DevOps"]
  },
  {
  ...
  },
  {
    ...
    description: "Centralized platform for service discovery, documentation, and developer workflows.",
    icon: Layout,
    items: ["Backstage", "Portal", "Cycloid", "Massdrive", "Rely"]
  },
  {
